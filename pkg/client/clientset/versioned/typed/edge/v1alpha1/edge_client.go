...
// EdgeV1alpha1Client is used to interact with features provided by the edge.k8s.io group.
type EdgeV1alpha1Client struct {
	restClient rest.Interface
}

func (c *EdgeV1alpha1Client) EdgeNodes(namespace string) EdgeNodeInterface {
